...
class FeatureIon(BaseModel):
    ...
    main_ion: Optional[StrictBool] = Field(default=None, alias="mainIon")
    __properties: ClassVar[List[str]] = ["ionNotation", "mz", "ccs", "id", "mainIon"]
