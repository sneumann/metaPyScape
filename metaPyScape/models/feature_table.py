...
class FeatureTable(BaseModel):
    ...
    processing_workflow: Optional[StrictStr] = Field(default=None, alias="processingWorkflow")
    __properties: ClassVar[List[str]] = ["id", "name", "polarity", "processingWorkflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processingWorkflow": obj.get("processingWorkflow")
        })
        return _obj
