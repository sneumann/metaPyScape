...
class MsSpectrum(BaseModel):
    """
    MsSpectrum
    """ # noqa: E501
    signals: Optional[List[Signal]] = None
    analysis_id: Optional[StrictStr] = Field(default=None, alias="analysisId")
    mean_measured_mz: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="meanMeasuredMz")
    ...
    __properties: ClassVar[List[str]] = ["signals", "analysisId", "meanMeasuredMz", "rtInSeconds", "ccs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meanMeasuredMz": obj.get("meanMeasuredMz"),
