...
class AnnotationToolConfiguration(BaseModel):
    """
    AnnotationToolConfiguration
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    scoring_configuration: Optional[ScoringConfiguration] = Field(default=None, alias="scoringConfiguration")
    __properties: ClassVar[List[str]] = ["id", "name", "scoringConfiguration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "scoringConfiguration": ScoringConfiguration.from_dict(obj["scoringConfiguration"]) if obj.get("scoringConfiguration") is not None else None
        })
        return _obj
