...
class ExperimentsApi(object):
    ...
    def create_experiment(self, body, **kwargs):  # noqa: E501
        ...
        This operation initiates the creation of an experiment by processing the provided project YAML. This YAML should define the project id and details about the experiment and feature table to be created.  # noqa: E501
        ...
        :param str body: The YAML file that references a project, and defines the structure of one experiment and one Feature Table. The Project ID is mandatory to create an experiment! (required)
